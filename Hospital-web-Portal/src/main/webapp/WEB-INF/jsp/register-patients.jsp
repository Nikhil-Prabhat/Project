...
<body>
	...
	<div class="container">
		...
		<form action="/registerpatient" class="needs-validation" novalidate
			method="post" modelAttribute="patient" style="position: relative; top: 40px">
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label for="age"><strong>Enter Age of the Patient</strong></label> <input
			...
			<div class="form-group">
				<label for="treatmentPackageName"><strong>Choose the Package for
